        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <a href="#beranda" className="flex items-center gap-3">
            <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-gold-400 to-gold-600 flex items-center justify-center">
              <span className="text-brown-900 font-display font-bold text-lg md:text-xl">م</span>
            </div>
            <div className="hidden sm:block">
              <h1 className="font-display text-lg md:text-xl font-bold text-foreground">Masjid Al-Ikhlas</h1>
              <p className="text-xs text-muted-foreground">Pusat Ibadah & Dakwah</p>
            </div>
          </a>
